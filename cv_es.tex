...
\section{Perfil}
Desarrolladora de Software (Intern) en ciberseguridad y estudiante de Ingenier\'ia en Tecnolog\'ias Computacionales que construye productos completos en Python y TypeScript. Dise\~no APIs REST, modelos de datos relacionales (PostgreSQL, Supabase) y frontends en React, con enfoque pr\'actico en herramientas de seguridad. He construido y desplegado aplicaciones de forma independiente y colaborado en equipos de ingenier\'ia con flujos de trabajo basados en Git.

\section{Habilidades T\'ecnicas}
\textbf{Lenguajes:} Python, TypeScript, JavaScript, Swift, Java, SQL, C/C++ (ESP32/Arduino), MATLAB \\
\textbf{Frontend:} React 19, Vite, TailwindCSS, Three.js / react-three-fiber, HTML, CSS \\
\textbf{Backend:} Flask, Node.js, Express, APIs REST, autenticaci\'on JWT, bcrypt, Swagger/OpenAPI \\
\textbf{Bases de datos:} PostgreSQL, Supabase, SQL Server, SQLite, Prisma ORM \\
\textbf{DevOps / Herramientas:} Docker, Railway, Vercel, Gunicorn, Git/GitHub, Playwright \\
\textbf{Datos / Modelaci\'on:} NumPy, Matplotlib, Seaborn, AgentPy
...
\project{Reto -- Sistema iOS de Gesti\'on de Turnos y Ventanillas}{Ago -- Dic 2025}{Swift, SwiftUI, MVVM, Flask, SQL Server \quad $\cdot$\ Individual}
\begin{itemize}
...
\resumeSubheading{Cybersecurity TEC (Grupo Estudiantil)}{01/2024 -- 12/2024}{Coordinadora de Log\'istica}
\begin{itemize}
    \item Organic\'e talleres de Linux, conferencias nacionales de ciberseguridad y la competencia inter-campus Zero2Hero 2024.
\end{itemize}
